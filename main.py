...
class TestUrbanRoutes:
    ...
    def test_fill_card(self):
        # Adicionar em S8
        print("função criada para definir número de cartão")
        pass
    ...
    def test_order_blanket_and_handkerchiefs(self):
        # Adicionar em S8
        print("função criada para definir pedido de cobertor e lenços")
        pass
    ...
    def test_car_search_model_appears(self):
        # Adicionar em S8
        print("função criada para definir modelo do carro")
        pass
